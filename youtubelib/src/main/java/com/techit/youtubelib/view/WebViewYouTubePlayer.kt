package com.techit.youtubelib.view
...
import com.techit.youtubelib.R
import com.techit.youtubelib.PlayerConstants
import com.techit.youtubelib.YouTubePlayerBridge
import com.techit.youtubelib.interfaces.YouTubePlayer
import com.techit.youtubelib.listeners.FullscreenListener
import com.techit.youtubelib.listeners.YouTubePlayerListener
import com.techit.youtubelib.options.IFramePlayerOptions
import com.techit.youtubelib.toFloat
...
internal class WebViewYouTubePlayer constructor(
  ...
  override fun onWindowVisibilityChanged(visibility: Int) {
    if (isBackgroundPlaybackEnabled && (visibility == GONE || visibility == INVISIBLE)) {
      return
    }
