package com.techit.youtubelib.utils
...
internal class NetworkObserver(private val context: Context) {
    ...
    private fun doObserveNetworkLegacy(context: Context) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
            context.registerReceiver(networkBroadcastReceiver, IntentFilter(ConnectivityManager.CONNECTIVITY_ACTION), Context.RECEIVER_NOT_EXPORTED)
        } else {
